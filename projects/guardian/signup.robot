...
${DEVICE_NAME}          #### Colocar o device ( use "adb device" no cmd para descobrir )
${APP}                  #C:/Users/gu062480/QAmobile/projects/guardian/base.apk #### Colocar o diretorio do apk
...
Login Nativo Guardian
    ...
    Input Text    xpath=//android.widget.EditText[@resource-id="usernameUserInput"]    guiuriarte@gmail.com
